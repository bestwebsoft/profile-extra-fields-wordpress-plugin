...
if ( ! function_exists( 'bws_plugins_admin_init' ) ) {
	function bws_plugins_admin_init() {
		if ( isset( $_GET['bws_activate_plugin'] ) && check_admin_referer( 'bws_activate_plugin' . sanitize_text_field( $_GET['bws_activate_plugin'] ) ) ) {
			...
			*/
			$is_main_page = in_array( sanitize_text_field( $_GET['page'] ), array( 'bws_panel', 'bws_themes', 'bws_system_status' ) );
...
if ( ! function_exists( 'bws_admin_enqueue_scripts' ) ) {
	function bws_admin_enqueue_scripts() {
		...
		if ( isset( $_GET['page'] ) && ( in_array( sanitize_text_field( $_GET['page'] ), array( 'bws_panel', 'bws_themes', 'bws_system_status' ) ) || strpos( $_GET['page'], '-bws-panel' ) ) ) {
...
if ( ! function_exists( 'bws_plugins_admin_head' ) ) {
	function bws_plugins_admin_head() {
		if ( isset( $_GET['page'] ) && sanitize_text_field( $_GET['page'] ) === 'bws_panel' ) {
			?>
			<noscript>
				<style type="text/css">
					.bws_product_button {
